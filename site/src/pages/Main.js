...
const Main = () => {
    ...
    useEffect(() => {
        ...
        if (!!q) {
            ...
            try {
                ...
                history.push(`/auctions?q=${escape(JSON.stringify(parsedQuery))}&st=${sortType}&so=${sortOrder}`);
    ...
    }, [server, level, maxLevel, skillValue, value, maxValue, skillType, sortType, sortOrder, history]);
